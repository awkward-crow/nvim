" vim color file
" 
" Thinner: My modifications to Less for R syntax
"
" <Original header>
"
...
hi Constant       term=bold cterm=none ctermfg=2 gui=none guifg=LightGray
hi Special        term=bold cterm=bold ctermfg=6 " gui=none guifg=Orange
hi Identifier     term=none cterm=none ctermfg=3 " gui=none guifg=LightGray
hi PreProc        term=underline cterm=none ctermfg=4 " gui=bold guifg=White
...
hi Statement      term=bold cterm=none ctermfg=7 gui=none guifg=White
hi Conditional    term=bold cterm=bold ctermfg=5 " gui=none guifg=LightBlue
hi Repeat         term=bold cterm=none ctermfg=3 " gui=none guifg=LightBlue
hi Keyword        term=bold cterm=none ctermfg=3 " gui=none guifg=LightBlue
