" vim color file
"
" snake - for python, based on less by ...
"
...
" hi String         term=bold cterm=bold ctermfg=0 gui=none guifg=DarkGray
" hi Function       term=bold cterm=bold ctermfg=2 gui=none guifg=Yellow
hi Function       term=bold cterm=bold ctermfg=6 gui=none guifg=Yellow
...
hi Conditional    term=bold cterm=bold ctermfg=5 gui=bold guifg=White
hi Include        term=bold cterm=none ctermfg=4 gui=none guifg=LightBlue
...
hi Defined        term=bold cterm=bold ctermfg=1 gui=none guifg=LightCyan
