...
hi Function       term=bold cterm=none ctermfg=2 gui=none guifg=Yellow
hi Statement      term=bold cterm=none ctermfg=7 gui=bold guifg=White
hi Conditional    term=bold cterm=bold ctermfg=7 gui=bold guifg=White
hi Keyword        term=bold cterm=none ctermfg=3 gui=bold guifg=White
...
hi Type           term=none cterm=bold ctermfg=4 gui=none guifg=LightGray
hi Defined        term=bold cterm=bold ctermfg=6 gui=none guifg=LightCyan
hi erlangEnd      term=bold cterm=bold ctermfg=6 gui=none guifg=LightCyan
